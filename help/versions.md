...
| [2.12.1](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.12.1) | Es handelt sich um eine Patch-Version für 2.12.0, die einen wichtigen Fehler in der [Image-Komponente behebt.](/help/components/image.md) | 6.4.8.1+ * | 6.5.5.0+ * | Kontinuierlich | 8, 11 | 5. November 2020 |
