...
Das Dialogfeld [Bearbeiten](#edit-dialog) ermöglicht die Definition des globalen Site-Navigationsstamms sowie die Tiefe der Navigation in der Struktur. Im [Design-Dialogfeld](#design-dialog)kann der Vorlagenautor die Standardwerte für dieselben Optionen festlegen.
...
Definiert die Stammseite der Navigationsstruktur.
   * Verwenden **Sie die** Schaltfläche &quot;Auswahl öffnen&quot; , um einfach die Inhaltsstruktur zu navigieren und den Stamm auszuwählen.
* **Sprachstrukturtiefe**
