...
Das Dialogfeld [&quot;Bearbeiten&quot;](#edit-dialog) ermöglicht es dem Inhaltsautor, die Navigationsstammseite zusammen mit der Navigationstiefe zu definieren. Das [Design-Dialogfeld](#design-dialog) ermöglicht es dem Vorlagenautor, Standardwerte für den Navigationsstamm und die Tiefe zu definieren.
...
Weitere Informationen zur Entwicklung Kernkomponenten finden Sie in der [Entwicklerdokumentation für Kernkomponenten](developing. md.

>[!NOTE]
>
>Ab Version 2.1.0 von Core Components unterstützt die Navigationskomponente [schema.org Microdata](https://schema.org).
