...
breadcrumb-title: Anleitung zu den Kernkomponenten
...
+ Die WCM-Komponenten {#wcm-components}
  ...
  + v2-Komponenten {#v2-components}
    ...
    + [Schnellsuche (v2)](/help/components/v2/quick-search.md)
...
+ Adaptive Formulare {#adaptive-forms}
  ...
  + Adaptive Formulare – Komponenten {#adaptive-forms-components}
    ...
    + {hide-from-toc}[Adaptive Forms-Bildauswahl](/help/adaptive-forms/components/image-choice.md)
