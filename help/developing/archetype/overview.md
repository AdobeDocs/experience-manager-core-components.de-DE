...
| `includeFormscommunications` | `n` | Enthält [Forms-Kernkomponenten](https://github.com/adobe/aem-core-forms-components) Abhängigkeiten, Vorlagen, Formulardatenmodelle, Designs und generieren entsprechende Artefakte für Forms Communications-Programme. |
| `includeFormsenrollment` | `n` | Enthält [Forms-Kernkomponenten](https://github.com/adobe/aem-core-forms-components) Abhängigkeiten, Vorlagen, Formulardatenmodelle, Designs und generieren entsprechende Artefakte für Forms-Registrierungsprogramme. |

## Systemanforderungen {#requirements}

| Archetyp | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [32](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-32) | Kontinuierlich | 6.5.7.0+ | 8, 11 | 3.3.9+ |
